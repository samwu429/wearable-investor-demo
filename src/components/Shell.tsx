    ...
    <div className="flex min-h-svh flex-col">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-void/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 md:px-6">
          ...
          >
            <span className="text-gold">Trust</span>Field
            <span className="ml-2 hidden text-xs font-normal text-mist sm:inline">
              穿戴式信任 · 演示
            </span>
          </NavLink>
      ...
      <footer className="border-t border-white/10 py-6 text-center text-xs text-mist">
